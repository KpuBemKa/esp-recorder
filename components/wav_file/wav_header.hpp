...
struct wav_header_t
{
  ...
  int wav_size = 0;    // Size of the wav portion of the file, which follows the
  ...
  int byte_rate = 32000;      // Number of bytes per second. sample_rate *
  ...
  int data_bytes = 0;  // Number of bytes in data. Number of samples *
                       // num_channels * sample byte size
