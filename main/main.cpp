...
void record(I2SMEMSSampler *input, const char *fname)
{
...
extern "C" void app_main(void)
{
    ...
    esp_log_level_set("I2SMEMSSampler", ESP_LOG_INFO);
    ...
    I2SMEMSSampler *input = new I2SMEMSSampler(I2S_NUM_0, i2s_mic_pins, i2s_mic_Config);
